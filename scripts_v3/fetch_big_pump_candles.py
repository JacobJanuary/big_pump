"""
Fetch and store 1-minute candles from Binance/Bybit API for each signal in web.big_pump_signals
Target Table: web.big_pump_minute_candles
"""
import sys
import os
...
def populate_big_pump_candles():
    """
    Fetch minute candles for all signals in web.big_pump_signals table
    """
    print("Fetching 1-minute candles for all signals (web.big_pump_signals)...")
    print("="*120)
    ...
    try:
        with get_db_connection() as conn:
            ...
            if not signals:
                print("No signals found in web.big_pump_signals table.")
                return
            ...
            for i, signal in enumerate(signals, 1):
                ...
                # Check if candles already exist in web.big_pump_minute_candles
                # Note: signal_analysis_id links to web.big_pump_signals.id
                check_query = """
                    SELECT COUNT(*) FROM web.big_pump_minute_candles
                ...
                if count >= 1430:
                    ...
                    delete_query = "DELETE FROM web.big_pump_minute_candles WHERE signal_analysis_id = %s"
                    with conn.cursor() as cur:
                ...
                insert_query = """
                    INSERT INTO web.big_pump_minute_candles (
